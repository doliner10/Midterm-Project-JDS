...
from PHX import load_PHX_parking, PHX_transform_data, PHX_transform_data, PHX_rename_data
from nyc import load_NYC_parking, remove_data, calculate_average
from charlotte import load_Charlotte_parking, remove_data
from indianapolis import indy_parking_data, narrow_down_data, transform_data, proper_names
from la import LA_parking_data, narrow_down_data, transform_data, convert_average_rate_to_float, proper_names
...
def load_Charlotte():
    ...
    Charlotte_data = remove_data(Charlotte_data)
